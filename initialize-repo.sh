...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-a3test1
echo     https://github.com/tfynes-pivotal/tap-gitops-a3test1
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-a3test1 --private
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-a3test1
git branch -M main
